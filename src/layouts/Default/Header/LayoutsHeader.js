...
import { faCircleQuestion, faCoins, faEllipsisVertical, faGear, faKeyboard, faLanguage, faMoon, faQuestionCircle, faRightFromBracket, faSpinner, faUser, faVideo, faXmarkCircle } from '@fortawesome/free-solid-svg-icons'
import { Link } from 'react-router-dom';

import styles from './Header.module.scss';
import avatar from './images/profile_user.jpeg';
...
function Header() {
    ...
    const dataMenuUser = [
        ...
        { title: 'Logout', icon: <FontAwesomeIcon icon={faRightFromBracket} />, }
    ]
                        ...
                        <div className={cx("user-action")}>
                            ...
                            <div className={cx("profile")}>
                                <MenuPopper items={dataMenuUser}>
                                    <Image src={avatar} alt="avatar" className={cx("profile-avatar")} />
                                </MenuPopper>
